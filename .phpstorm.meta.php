...
'filesystems.links./www/public/storage','l5-swagger.default','l5-swagger.documentations.default.api.title','l5-swagger.documentations.default.routes.api','l5-swagger.documentations.default.paths.use_absolute_path',
...
'self-diagnosis.checks.Tests\\Checks\\RedisCanBeAccessed.connections','self-diagnosis.checks.BeyondCode\\SelfDiagnosis\\Checks\\SupervisorProgramsAreRunning.programs','self-diagnosis.checks.BeyondCode\\SelfDiagnosis\\Checks\\SupervisorProgramsAreRunning.restarted_within','self-diagnosis.environment_checks.development','self-diagnosis.environment_checks.production',
'self-diagnosis.environment_checks.production.BeyondCode\\SelfDiagnosis\\Checks\\PhpExtensionsAreDisabled.extensions','services.postmark.token','services.resend.key','services.ses.key','services.ses.secret',
...
'session.secure','session.http_only','session.same_site','session.partitioned','horizon.domain',
